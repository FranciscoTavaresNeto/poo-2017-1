...
/**
 * API de uma lista com operações básicas de inserção, consulta, exclusão.
 *
...
public interface IList {
    ...
    /**
     * Adiciona o elemento no fim da lista. Parâmetros null são ignorados.
     *
    ...
    /**
     * Adiciona o elemento no inicio da lista. Parâmetros null são ignorados.
     *
     * @param o Elemento a ser adicionado
     */
    ...
    /**
     * Obtém um elemento dado um índice. Índices não existentes retornam null.
     *
    ...
    /**
     * Retorna o primeiro elemento da lista. Este método tem o mesmo efeito de
     * get(0). Retorna null se a lista estiver vazia.
     *
    ...
    /**
     * Retorna o último elemento da lista. Este método tem o mesmo efeito de
     * get(count() - 1). Retorna null se a lista estiver vazia.
     *
    ...
    /**
     * Remove e retorna o elemento contido no índice passado. Retorna null se
     * não há elemento no índice.
     *
    ...
    /**
     * Remove o elemento contido no índice passado. Retorna true se o elemento
     * foi removido e false caso contrário.
     *
     * @param index Índice do elemento a ser removido.
    ...
    /**
     * Remove o elemento da lista. Retorna true se o objeto foi encontrado e
     * removido e false caso contrário.
     *
    ...
    /**
     * Remove todos os elementos da lista. Este método reseta a lista.
     */
    public void clean();
     ...
     * @return boolean true ou false caso o elemento se encontre ou não na
     * lista.
     */
